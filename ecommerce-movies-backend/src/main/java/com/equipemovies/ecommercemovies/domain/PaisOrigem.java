...
public class PaisOrigem implements Serializable {
	...
	//@OneToOne(cascade = CascadeType.ALL, mappedBy = "filme") 	// So that the pais_origem ID is the same as the filme, mapping to pais_origem
	//private Filme filme;
	...
	public PaisOrigem(Integer id, String nome) {
		super();
		this.id = id;
		this.nome = nome;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PaisOrigem other = (PaisOrigem) obj;
		if (id == null) {
			if (other.id != null)
				return false;
